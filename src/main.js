...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      ['Frontier-Scale Open Models · MoE', 'AI'],
  ...
  },
  {
    ...
    body: [
      ...
      '',
      'Self-host frontier-scale open-weight',
      'LLMs — DeepSeek V4-class — end-to-end.',
      'Serving · quantization · GPU infra.',
      'Zero third-party APIs.',
      '',
      'Distributed agentic AI: Go multi-agent,',
      'encrypted, sovereign, self-deploying.',
      '',
      'Agentic harness + tool-calling ops',
      'console on a self-hosted 7B model.',
    ],
    accent: '#ffb000',
  },
  {
